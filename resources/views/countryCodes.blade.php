<select id="countryCode" class="form-control input-sm col-xs-4">
    ...
    <option value="994">Azerbaijan Republic (+994)</option>
    ...
    <option value="246">Chagos Archipelago (+246)</option>
    <option value="56">Chile (+56)</option>
    <option value="61">Christmas Island (+61)</option>
    <option value="891">Cocos Island (+891)</option>
    <option value="57">Colombia (+57)</option>
    <option value="1767">Commonwealth of Dominica (+1767)</option>
    ...
    <option value="266">Kingdom Of Lesotho (+266)</option>
    ...
    <option value="248">Republic Of Seychelles (+248)</option>
    <option value="378">Republic of San Marino (+378)</option>
    ...
    <option value="992">Tajlkistan (+992)</option>
    ...
    <option value="1649">Turks and Caios Islands (+1649)</option>
    ...
    <option value="1">Unites States Minor Outlying Islands (+1)</option>
    ...
    <option value="1">Virgin Islands (GB) (+1)</option>
    <option value="1340">Virgin Islands(U.S.) (+1340)</option>
    <option value="681">Walls  Islands (+681)</option>
