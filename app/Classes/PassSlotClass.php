...
class PassSlotClass
{
     ...
     * @return object
     */
    public function createTemplate($httpMethod, $content)
    {
        $resource = '/templates';
        return $this->_restCall($httpMethod, $resource, $content);
    }
    ...
    private function _restCall($httpMethod, $resource, $content = null, $multipart = false)
    {
        ...
        if (file_exists('/files/cacert.pem')) {
...
class PassSlotApiException extends Exception
{
    ...
    public function __construct($message, $code = 0)
    {
        ...
        $exception = $json ? $json->message : $message ? $message : 'Error while saving. Please try again.'; //edited by rawbee
